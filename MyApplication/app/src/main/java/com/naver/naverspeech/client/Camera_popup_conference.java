...
public class Camera_popup_conference extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_popup_conference);
        imageView = (ImageView) findViewById(R.id.save_image);
        getcamera = (Button) findViewById(R.id.getcamera);
        getalbum = (Button) findViewById(R.id.getalbum);
        save_filename =(TextView) findViewById(R.id.save_filename);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.camera_upload:
                ...
                Intent intent = new Intent(Camera_popup_conference.this,Save_Conference.class);
